...
* Again, we ignore filter parameters which will create a bloom filter with more
* hash functions than the protocol limits
...
bool CBloomFilter::IsRelevantAndUpdate(const CTransaction &tx) {
    ...
    for (unsigned int i = 0; i < tx.vout.size(); i++) {
        ...
        // This means clients don't have to update the filter themselves when a
        // new relevant tx
