...
public:
    CMainParams() {
        ...
        vSeeds.push_back(
            CDNSSeedData("bitcoinstats.com", "seed.bitcoinstats.com",
        ...
        chainTxData = ChainTxData{
            ...
            184495391,  // * total number of transactions between genesis and
                        // that timestamp
            //   (the tx=... number in the SetBestChain debug.log lines)
            3.2 // * estimated number of transactions per second after that
                // timestamp
        };
    }
};
...
public:
    CRegTestParams() {
        ...
        consensus.BIP34Height = 100000000; // BIP34 has not activated on regtest
                                           // (far in the future so block v1 are
