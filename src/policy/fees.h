 ...
 * we count the number of transactions in each bucket and the total amount of
 * feerate
...
private:
    CFeeRate
        minTrackedFee; //!< Passed to constructor to avoid dependency on main
