...
std::string EntryDescriptionString() {
    return "    \"size\" : n,             (numeric) virtual transaction size "
           "as defined in BIP 141. This is different from actual serialized "
...
UniValue getblock(const JSONRPCRequest &request) {
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw runtime_error(
            ...
            "  \"strippedsize\" : n,    (numeric) The block size excluding "
            "witness data\n"
            "  \"weight\" : n           (numeric) The block weight as defined "
            "in BIP 141\n"
            "  \"height\" : n,          (numeric) The block height or index\n"
            "  \"version\" : n,         (numeric) The block version\n"
            "  \"versionHex\" : \"00000000\", (string) The block version "
