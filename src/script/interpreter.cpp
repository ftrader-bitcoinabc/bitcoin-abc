            ...
            if (fExec && 0 <= opcode && opcode <= OP_PUSHDATA4) {
                ...
                switch (opcode) {
                    ...
                    case OP_CHECKLOCKTIMEVERIFY: {
                        ...
                        // beyond the 2**32-1 limit of the nLockTime field
                        // itself.
                    ...
                    case OP_CHECKSEQUENCEVERIFY: {
                        ...
                        // integer
                        // field. See the comment in CHECKLOCKTIMEVERIFY
                        // regarding
                    ...
                    case OP_EQUALVERIFY:
                        // case OP_NOTEQUAL: // use OP_NUMNOTEQUAL
                        {
                            ...
                            // easy to say
                            // something like n != 1 and have some wiseguy pass
                            // in 1 with extra
                            // zero bytes after it (numerically, 0x01 == 0x0001
                            // == 0x000001)
                    ...
                    case OP_CHECKMULTISIGVERIFY: {
                        ...
                        // the stack. Top stack item = 1.
                        // With SCRIPT_VERIFY_NULLFAIL, this is used for cleanup
                        // if operation fails.
                        ...
                        while (fSuccess && nSigsCount > 0) {
                            ...
                            // pubkey/signature evaluation
                            // distinguishable by CHECKMULTISIG NOT if the
                            // STRICTENC flag is set.
                        ...
                        // mutability,
                        // so optionally verify it is exactly equal to zero
                        // prior
...
private:
    const CTransaction &txTo;  //!< reference to the spending transaction (the
...
uint256 SignatureHash(const CScript &scriptCode, const CTransaction &txTo,
    ...
    if (sigversion == SIGVERSION_WITNESS_V0) {
        ...
        // amount)
        // The prevout may already be contained in hashPrevout, and the
        // nSequence
...
bool VerifyScript(const CScript &scriptSig, const CScript &scriptPubKey,
    ...
    if (flags & SCRIPT_VERIFY_WITNESS) {
        ...
        // so require
        // that WITNESS implies P2SH. Otherwise, going from
        // WITNESS->P2SH+WITNESS would be
