 ...
 * an int64 and allowing out-of-range values to be returned as a vector of bytes
 * but
...
public:
    ...
    static std::vector<unsigned char> serialize(const int64_t &value) {
        ...
        //    - If the most significant byte is >= 0x80 and the value is
        //    negative, push a
        //    new 0x80 byte that will be popped off when converting to an
        //    integral.

        //    - If the most significant byte is < 0x80 and the value is
        //    negative, add
        //    0x80 to it, since it will be subtracted and interpreted as a
        //    negative when
