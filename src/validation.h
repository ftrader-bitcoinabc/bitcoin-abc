 ...
 * This does not modify the UTXO set. If pvChecks is not NULL, script checks are
 * pushed onto it
 ...
 * represented by coins.
 *  In case pfClean is provided, operation will try to be tolerant about errors,
 * and *pfClean
 *  will be true if no problems were found. Otherwise, the return value will be
 * false in case
