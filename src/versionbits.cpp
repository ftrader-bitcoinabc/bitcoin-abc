...
int AbstractThresholdConditionChecker::GetStateSinceHeightFor(
    ...
    // computing for, thus:
    // if we are computing for the last block of a period, then pindexPrev
    // points to the second to last block of the period, and
    // if we are computing for the first block of a period, then pindexPrev
    // points to the last block of the previous period.
